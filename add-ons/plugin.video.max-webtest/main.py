...
VIDEOS =    {   'koditest.prunus.ca': [{   'name': 'koditest',
                                'thumb': 'https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcTXUXN7qVWrBZPfNJL8JZY2c0CReT_pbXvbwMLLN0YKsgc2eJZGGA',
                                'video': 'http://koditest.prunus.ca/test_video',
                                'genre': 'genre test'
                            }]
            }
